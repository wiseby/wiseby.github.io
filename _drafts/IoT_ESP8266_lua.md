...
Lua is like Python a Interpreted language and the syntax is more the like. The most important thing is that the Lua interpreter can be flashed to a ESP8266 my favorite is the ESP-01.

Install espTool from espressif for flashing.

Install (NodeMCU-uploader)[https://github.com/kmpm/nodemcu-uploader] to upload files/programs running NodeMCU firmware
...
- (NodeMCU Firmware builder)[https://nodemcu-build.com/index.php]